...
Далее необходимо создать пустой репозиторий на GitHub или его аналоге, нажав кнопку New, даь ему соответствующее название, по желанию заполнив Описание (Description), выбрать все необходимые опции и нажать кнопку Create repository.
